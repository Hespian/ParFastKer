...
public:
    ...
    parallel_reductions_old *pAlg;

public:
    parallel_modified(int const add, std::vector<int> &removed, std::vector<int> &vs, std::vector<std::vector<int>> &newAdj, parallel_reductions_old *_pAlg);

    parallel_modified(std::vector<int> &removed, std::vector<int> &vs, parallel_reductions_old *_pAlg);
...
public:
    parallel_fold(int const add, std::vector<int> &removed, std::vector<int> &vs, std::vector<std::vector<int>> &newAdj, parallel_reductions_old *_pAlg)
    : parallel_modified(add, removed, vs, newAdj, _pAlg)
    { }

    parallel_fold(std::vector<int> &removed, std::vector<int> &vs, parallel_reductions_old *_pAlg)
...
public:
    ...
    parallel_alternative(int const add, std::vector<int> &removed, std::vector<int> &vs, std::vector<std::vector<int>> &newAdj, parallel_reductions_old *_pAlg, int k)
    : parallel_modified(add, removed, vs, newAdj, _pAlg)
    {
        this->k = k;
    }

    parallel_alternative(std::vector<int> &removed, std::vector<int> &vs, parallel_reductions_old *_pAlg, int k)
    : parallel_modified(removed, vs, _pAlg)
    {
        this->k = k;
    }
