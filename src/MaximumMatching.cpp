/*
 * This is a modified version of code written by Ariful Azad (azad@lbl.gov) and Aydin Buluc (abuluc@lbl.gov), released under the BSD 3-clause license with the following copyright notice:
 *
